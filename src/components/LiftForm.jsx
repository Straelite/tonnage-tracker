...
class LiftForm extends Component {
        ...
        return (
            <>
                ...
                <form data-js-save-lift onSubmit={this.handleAddLiftClick}>
                    <input placeholder="Weight" type="number" name="weight" required />
                    <input placeholder="Reps" type="number" name="reps" required />
    ...
    handleAddLiftClick = (e) => {
        ...
        let newLift = new Lift(processedLiftData.date, processedLiftData.liftName, processedLiftData.reps, processedLiftData.weight);
